...
<div class="subbar">
  <nav class="breadcrumb">
    ...
    <span class="sep">/</span>
    <span class="current">Nueva entidad</span>
  </nav>
</div>
  ...
  <div class="form-card">
    ...
    <div class="sec">
      ...
      <div class="grid-row">
        ...
        <div class="field col-3 min-w-siglas"><label class="lbl-nowrap">Nombre corto / Siglas</label><input bind:value={form.nombre_corto} placeholder="GADM, MIN..." /></div>
