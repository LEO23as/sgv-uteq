...
MIDDLEWARE = [
    ...
    'vinculacion.middleware.AuthMiddleware',
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'vinculacion.context_processors.periodo_activo',
            ],
        },
    },
]
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default=config('EMAIL_HOST_USER', default='noreply@uteq.edu.ec'))
