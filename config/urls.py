...
urlpatterns = [
    ...
    path('api/dispositivos/vincular/', views.api_vincular_dispositivo, name='api_vincular_dispositivo'),
...
urlpatterns += [
    re_path(r'^media/(?P<path>.*)$', views.servir_documento_inline, name='servir_documento_inline'),
]
